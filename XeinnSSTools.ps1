...
<Window
                                    ...
                                    <Thumb>
                                        <Thumb.Template>
                                            <ControlTemplate TargetType="Thumb">
                                                <Border Background="#4A1010" CornerRadius="3" Margin="1,0"/>
                                            </ControlTemplate>
                                        </Thumb.Template>
                                    </Thumb>
                                </Track.Thumb>
    ...
    <Grid>
        ...
        <Border Grid.Row="0" Background="#111111" BorderBrush="#2A0A0A" BorderThickness="0,0,0,1" Padding="24,0">
            <Grid>
        ...
        <Border Grid.Row="1" Background="#0D0D0D" BorderBrush="#2A0A0A" BorderThickness="0,0,0,1">
            <TextBlock Text="X E I N N   T O O L S"
                       Foreground="#C0392B"
                       FontSize="20"
                       FontWeight="Bold"
        ...
        <Border Grid.Row="3" Background="#111111" BorderBrush="#2A0A0A" BorderThickness="0,1,0,0" Padding="24,0">
            <Grid>
